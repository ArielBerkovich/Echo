...
export const api = {
  ...
  getGroup: (groupId, legacyId) => request(`/groups/${encodeURIComponent(legacyId || groupId)}`),
  createGroup: (payload) => request("/groups", { method: "POST", body: payload }),
  updateGroup: (groupId, payload) => request(`/groups/${encodeURIComponent(groupId)}`, { method: "PATCH", body: payload }),
  deleteGroup: (groupId) => request(`/groups/${encodeURIComponent(groupId)}`, { method: "DELETE" }),
  addGroupMember: (groupId, userId) => request(`/groups/${encodeURIComponent(groupId)}/members`, { method: "POST", body: { userId } }),
  ...
  leaveGroup: (groupId) => request(`/groups/${encodeURIComponent(groupId)}/leave`, { method: "POST" }),
  ...
  markActivityRead: (items) => request("/activity/read", { method: "POST", body: { items } }),
